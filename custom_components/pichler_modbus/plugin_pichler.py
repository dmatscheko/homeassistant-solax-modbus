...
NUMBER_TYPES = [
    ...
    PichlerModbusNumberEntityDescription(
        name="Volumenstrom Lüftungsstufe 1",
    ...
    PichlerModbusNumberEntityDescription(
        name="Volumenstrom Lüftungsstufe 2",
    ...
    PichlerModbusNumberEntityDescription(
        name="Volumenstrom Lüftungsstufe 3",
    ...
    PichlerModbusNumberEntityDescription(
        name="Volumenstrom Grundlüftung",
...
SENSOR_TYPES_MAIN: list[PichlerModbusSensorEntityDescription] = [
    ...
    PichlerModbusSensorEntityDescription(
        name="Zuluftventilator Drehzahl",
    ...
    PichlerModbusSensorEntityDescription(
        name="Abluftventilator Drehzahl",
